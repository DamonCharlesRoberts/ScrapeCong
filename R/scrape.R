...
senmaleD <- function() {
  dougjones <- rtweet::get_timeline('@SenDougJones', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
...
bennet <- rtweet::get_timeline('@SenatorBennet', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
save_as_csv(bennet, "data/bennet.csv", prepend_ids =  TRUE, na = "", fileEncoding = "UTF-8")
bennettweets <- readr::read_csv("data/bennet.csv")
blumenthal <- rtweet::get_timeline('@SenBlumenthal', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
...
murphey <- rtweet::get_timeline('@SenMurphyOffice', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
save_as_csv(murphey, "data/murphy.csv", prepend_ids =  TRUE, na = "", fileEncoding = "UTF-8")
murpheytweets <- readr::read_csv("data/murphy.csv")
chriscoons <- rtweet::get_timeline('@ChrisCoons', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
...
cooper <- rtweet::get_timeline('@SenatorCarper', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
save_as_csv(cooper, "data/cooper.csv", prepend_ids =  TRUE, na = "", fileEncoding = "UTF-8")
coopertweets <- readr::read_csv("data/cooper.csv")
brianschatz <- rtweet::get_timeline('@SenBrianSchatz', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
save_as_csv(brianschatz, "data/brianschatz.csv")
brianschatztweets <- readr::read_csv("data/brianschatz.csv")
durbin <- rtweet::get_timeline('@SenatorDurbin', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
save_as_csv(durbin, "data/durbin.csv", prepend_ids =  TRUE, na = "", fileEncoding = "UTF-8")
durbintweets <- readr::read_csv("data/durbin.csv")
markey <- rtweet::get_timeline('@SenMarkey', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
save_as_csv(markey, "data/markey.csv", prepend_ids =  TRUE, na = "", fileEncoding = "UTF-8")
markeytweets <- readr::read_csv("data/markey.csv")
cardin <- rtweet::get_timeline('@SenatorCardin', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
save_as_csv(cardin, "data/cardin.csv", prepend_ids =  TRUE, na = "", fileEncoding = "UTF-8")
cardintweets <- readr::read_csv("data/cardin.csv")
chrisvanhollen <- rtweet::get_timeline('@ChrisVanHollen', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
...
garypeters <- rtweet::get_timeline('@SenGaryPeters', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
...
booker <- rtweet::get_timeline('@SenBooker', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
save_as_csv(booker, "data/booker.csv", prepend_ids =  TRUE, na = "", fileEncoding = "UTF-8")
bookertweets <- readr::read_csv("data/booker.csv")
menedez <- rtweet::get_timeline('@SenatorMenendez', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
save_as_csv(menedez, "data/menedez.csv", prepend_ids =  TRUE, na = "", fileEncoding = "UTF-8")
menedeztweets <- readr::read_csv("data/menedez.csv")
martinheinrich <- rtweet::get_timeline('@MartinHeinrich', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
...
tomudall <- rtweet::get_timeline('@SenatorTomUdall', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
...
schumer <- rtweet::get_timeline('@SenSchumer', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
save_as_csv(schumer, "data/schumer.csv", prepend_ids =  TRUE, na = "", fileEncoding = "UTF-8")
schumertweets <- readr::read_csv("data/schumer.csv")
sherrodbrown <- rtweet::get_timeline('@SenSherrodBrown', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
...
jeffmerkley <- rtweet::get_timeline('@SenJeffMerkley', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
...
ronwyden <- rtweet::get_timeline('@RonWyden', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
...
bobcasey <- rtweet::get_timeline('@SenBobCasey', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
...
toomey <- rtweet::get_timeline('@SenToomey', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
save_as_csv(toomey, "data/toomey.csv", prepend_ids =  TRUE, na = "", fileEncoding = "UTF-8")
toomeytweets <- readr::read_csv("data/toomey.csv")
jackreed <- rtweet::get_timeline('@SenJackReed', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
...
whitehouse <- rtweet::get_timeline('@SenWhitehouse', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
...
leahy <- rtweet::get_timeline('@SenatorLeahy', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
save_as_csv(leahy, "data/leahy.csv", prepend_ids =  TRUE, na = "", fileEncoding = "UTF-8")
leahytweets <- readr::read_csv("data/leahy.csv")
sanders <- rtweet::get_timeline('@SenSanders', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
save_as_csv(sanders, "data/sanders.csv", prepend_ids =  TRUE, na = "", fileEncoding = "UTF-8")
sanderstweets <- readr::read_csv("data/sanders.csv")
warner <- rtweet::get_timeline('@MarkWarner', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
save_as_csv(warner, "data/warner.csv", prepend_ids =  TRUE, na = "", fileEncoding = "UTF-8")
warnertweets <- readr::read_csv("data/warner.csv")
joemanchin <- rtweet::get_timeline('@Sen_JoeManchin', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
...
senfemD <- function() {
  sinema <- rtweet::get_timeline('@SenatorSinema', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
save_as_csv(sinema,"data/sinema.csv", prepend_ids =  TRUE, na = "", fileEncoding = "UTF-8")
sinematweets <- readr::read_csv("data/sinema.csv")
feinstein <- rtweet::get_timeline('@SenFeinstein', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
...
kamalaharris <- rtweet::get_timeline('@SenKamalaHarris', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
...
maziehirono <- rtweet::get_timeline('@maziehirono', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
...
duckworth <- rtweet::get_timeline('@SenDuckworth', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
...
warren <- rtweet::get_timeline('@SenWarren', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
save_as_csv(warren,"data/warren.csv", prepend_ids =  TRUE, na = "", fileEncoding = "UTF-8")
warrentweets <- readr::read_csv("data/warren.csv")
stabenow <- rtweet::get_timeline('@SenStabenow', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
...
amyklobuchar <- rtweet::get_timeline('@SenAmyKlobuchar', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
...
tinasmith <- rtweet::get_timeline('@SenTinaSmith', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
...
hassan <- rtweet::get_timeline('@SenatorHassan', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
save_as_csv(hassan,"data/hassan.csv", prepend_ids =  TRUE, na = "", fileEncoding = "UTF-8")
hassantweets <- readr::read_csv("data/hassan.csv")
shaheen <- rtweet::get_timeline('@SenatorShaheen', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
save_as_csv(shaheen,"data/shaheen.csv", prepend_ids =  TRUE, na = "", fileEncoding = "UTF-8")
shaheentweets <- readr::read_csv("data/shaheen.csv")
cortezmasto <- rtweet::get_timeline('@SenCortezMasto', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
...
jackyrosen <- rtweet::get_timeline(' @SenJackyRosen', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
...
gillibrand <- rtweet::get_timeline('@gillibrandny', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
...
cantwell <- rtweet::get_timeline('@SenatorCantwell', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
...
pattymurray <- rtweet::get_timeline('@PattyMurray', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
...
baldwin <- rtweet::get_timeline('@SenatorBaldwin', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
...
senfemR <- function() {
  lisamurkowski<- rtweet::get_timeline('@lisamurkowski', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
...
mcsally <- rtweet::get_timeline('@SenMcSallyAZ', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
save_as_csv(mcsally,"data/mcsally.csv", prepend_ids =  TRUE, na = "", fileEncoding = "UTF-8")
mcsallytweets <- readr::read_csv("data/mcsally.csv")
joniernst <- rtweet::get_timeline('@SenJoniErnst', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
...
collins <- rtweet::get_timeline('@SenatorCollins', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
save_as_csv(collins,"data/collins.csv", prepend_ids =  TRUE, na = "", fileEncoding = "UTF-8")
collinstweets <- readr::read_csv("data/collins.csv")
hydesmith <- rtweet::get_timeline('@SenHydeSmith', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
...
fischer <- rtweet::get_timeline('@SenatorFischer', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
save_as_csv(fischer,"data/fischer.csv", prepend_ids =  TRUE, na = "", fileEncoding = "UTF-8")
fischertweets <- readr::read_csv("data/fischer.csv")
marshablackburn <- rtweet::get_timeline('@MarshaBlackburn', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
...
capito <- rtweet::get_timeline('@SenCapito', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
...
senmaleR <- function() {
  donsullivan <- rtweet::get_timeline('@SenDanSullivan', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
shelby <- rtweet::get_timeline('@SenShelby', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
johnboozman <- rtweet::get_timeline('@JohnBoozman', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
tomcotton <- rtweet::get_timeline('@SenTomCotton', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
corygardner <- rtweet::get_timeline('@SenCoryGardner', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
rubio <- rtweet::get_timeline('@SenRubioPress', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
rickscott<- rtweet::get_timeline('@SenRickScott', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
isakson <- rtweet::get_timeline('@SenatorIsakson', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
davidperdue <- rtweet::get_timeline('@sendavidperdue', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
chuckgrassley <- rtweet::get_timeline('@ChuckGrassley', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
mikecrapo <- rtweet::get_timeline('@MikeCrapo', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
risch <- rtweet::get_timeline('@SenatorRisch', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
braun<- rtweet::get_timeline('@SenatorBraun', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
toddyoung<- rtweet::get_timeline('@SenToddYoung', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
jerrymoran<- rtweet::get_timeline('@JerryMoran', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
patroberts<- rtweet::get_timeline('@SenPatRoberts', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
mitchmconnell<- rtweet::get_timeline('@SenateMajLdr', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
randpaul<- rtweet::get_timeline('@RandPaul', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
billcassidy<- rtweet::get_timeline('@SenBillCassidy', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
johnkennedy<- rtweet::get_timeline('@SenJohnKennedy', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
royblunt<- rtweet::get_timeline('@RoyBlunt', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
hawley<- rtweet::get_timeline('@SenHawleyPress', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
wicker<- rtweet::get_timeline('@SenatorWicker', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
stevedaines<- rtweet::get_timeline('@SteveDaines', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
burr<- rtweet::get_timeline('@SenatorBurr', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
thomtillis<- rtweet::get_timeline('@SenThomTillis', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
kevincramer<- rtweet::get_timeline('@@SenKevinCramer', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
johnhoeven<- rtweet::get_timeline('@SenJohnHoeven', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
sasse<- rtweet::get_timeline('@SenSasse', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
robportman<- rtweet::get_timeline('@senrobportman', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
jiminhofe<- rtweet::get_timeline('@JimInhofe', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
lankford<- rtweet::get_timeline('@SenatorLankford', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
lindseygraham<- rtweet::get_timeline('@LindseyGrahamSC', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
timscott<- rtweet::get_timeline('@SenatorTimScott', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
rounds<- rtweet::get_timeline('@SenatorRounds', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
johnthune<- rtweet::get_timeline('@SenJohnThune', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
alexander<- rtweet::get_timeline('@SenAlexander', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
johncornyn<- rtweet::get_timeline('@JohnCornyn', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
tedcruz<- rtweet::get_timeline('@SenTedCruz', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
mikelee<- rtweet::get_timeline('@SenMikeLee', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
romney<- rtweet::get_timeline('@SenatorRomney', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
ronjohnson<- rtweet::get_timeline('@SenRonJohnson', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
johnbarrasso<- rtweet::get_timeline('@SenJohnBarrasso', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
enzi<- rtweet::get_timeline('@SenatorEnzi', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
...
horfemR <- function() {
  martharoby <- rtweet::get_timeline('@RepMarthaRoby', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  walorski <- rtweet::get_timeline('@RepWalorski', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  susanbrooks <- rtweet::get_timeline('@SusanWBrooks', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  annwagner <- rtweet::get_timeline('@RepAnnWagner', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  hartzler <- rtweet::get_timeline('@RepHartzler', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  virginiafoxx <- rtweet::get_timeline('@virginiafoxx', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  armstrong <- rtweet::get_timeline('@RepArmstrongND', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  stefanik <- rtweet::get_timeline('@RepStefanik', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  cathymcmorris <- rtweet::get_timeline('@cathymcmorris', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  lizcheney<- rtweet::get_timeline('@RepLizCheney', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
...
horfemD <- function() {
  terrisewell <- rtweet::get_timeline('@RepTerriSewell', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  kirkpatrick<- rtweet::get_timeline('@RepKirkpatrick', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  dorismatsui<- rtweet::get_timeline('@DorisMatsui', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  bera<- rtweet::get_timeline('@RepBera', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  pelosi <- rtweet::get_timeline('@SpeakerPelosi', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  barbaralee <- rtweet::get_timeline('@RepBarbaraLee', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  speier <- rtweet::get_timeline('@RepSpeier', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  annaeshoo <- rtweet::get_timeline('@RepAnnaEshoo', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  zoelofgren <- rtweet::get_timeline('@RepZoeLofgren', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  katiehill <- rtweet::get_timeline('@RepKatieHill', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  brownley <- rtweet::get_timeline('@RepBrownley', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  judychu <- rtweet::get_timeline('@RepJudyChu', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  gracenapolitano <- rtweet::get_timeline('@gracenapolitano', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  normatorres <- rtweet::get_timeline('@NormaJTorres', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  karenbass <- rtweet::get_timeline('@RepKarenBass', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  lindasanchez <- rtweet::get_timeline('@RepLindaSanchez', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  roybalallard<- rtweet::get_timeline('@RepRoybalAllard', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  maxinewaters<- rtweet::get_timeline('@RepMaxineWaters', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  barragan<- rtweet::get_timeline('@RepBarragan', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  katieporter <- rtweet::get_timeline('@RepKatiePorter', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  susandavis <- rtweet::get_timeline('@RepSusanDavis', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  dianadegette <- rtweet::get_timeline('@RepDianaDeGette', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  rosadelauro<- rtweet::get_timeline('@rosadelauro', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  jahanahayes<- rtweet::get_timeline('@RepJahanaHayes', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  lbr<- rtweet::get_timeline('@RepLBR', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  eleanornorton<- rtweet::get_timeline('@EleanorNorton', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  stephmurphy<- rtweet::get_timeline('@RepStephMurphy', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  kcastor<- rtweet::get_timeline('@USRepKCastor', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  hastings <- rtweet::get_timeline('@RepHastingsFL', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  loisfrankel <- rtweet::get_timeline('@RepLoisFrankel', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  dwstweets <- rtweet::get_timeline('@RepDWStweets', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  wilson <- rtweet::get_timeline('@RepWilson', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  dmp <- rtweet::get_timeline('@RepDMP', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  shalala <- rtweet::get_timeline('@RepShalala', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  tulsi <- rtweet::get_timeline('@TulsiPress', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  finkenauer <- rtweet::get_timeline('@RepFinkenauer', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  cindyaxne <- rtweet::get_timeline('@RepCindyAxne', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  robinkelly <- rtweet::get_timeline('@RepRobinKelly', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  janschakowsky <- rtweet::get_timeline('@janschakowsky', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  underwood <- rtweet::get_timeline('@RepUnderwood', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  cheri <- rtweet::get_timeline('@RepCheri', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  davids <- rtweet::get_timeline('@RepDavids', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  loritrahan <- rtweet::get_timeline('@RepLoriTrahan', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  kclark <- rtweet::get_timeline('@RepKClark', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  pressley <- rtweet::get_timeline('@RepPressley', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  haleystevens <- rtweet::get_timeline('@RepHaleyStevens', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  debdingell <- rtweet::get_timeline('@RepDebDingell', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  rashida <- rtweet::get_timeline('@RepRashida', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  lawrence <- rtweet::get_timeline('@RepLawrence', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  angiecraig <- rtweet::get_timeline('@RepAngieCraig', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  deanphillips <- rtweet::get_timeline('@RepDeanPhillips', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  bettymccollum <- rtweet::get_timeline('@BettyMcCollum04', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  ilhan<- rtweet::get_timeline('@Ilhan', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  lacyclay <- rtweet::get_timeline('@LacyClayMO1', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  adams <- rtweet::get_timeline('@RepAdams', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  anniekuster <- rtweet::get_timeline('@RepAnnieKuster', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  bonnie<- rtweet::get_timeline('@RepBonnie', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  debhaaland <- rtweet::get_timeline('@RepDebHaaland', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  torressmall <- rtweet::get_timeline('@RepTorresSmall', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  dinatitus<- rtweet::get_timeline('@repdinatitus', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  susielee <- rtweet::get_timeline('@RepSusieLee', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  kathleenrice <- rtweet::get_timeline('@RepKathleenRice', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  nydiavelazquez<- rtweet::get_timeline('@NydiaVelazquez', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  yvetteclarke<- rtweet::get_timeline('@RepYvetteClarke', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  maloney<- rtweet::get_timeline('@RepMaloney', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  aoc <- rtweet::get_timeline('@RepAOC', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  nitalowey <- rtweet::get_timeline('@NitaLowey', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  beatty <- rtweet::get_timeline('@RepBeatty', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  marcykaptur <- rtweet::get_timeline('@RepMarcyKaptur', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  marciafudge<- rtweet::get_timeline('@RepMarciaFudge', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  kendrahorn<- rtweet::get_timeline('@RepKendraHorn', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  bonamici <- rtweet::get_timeline('@RepBonamici', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  mgs <- rtweet::get_timeline('@RepMGS', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  dean <- rtweet::get_timeline('@RepDean', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  houlahan <- rtweet::get_timeline('@RepHoulahan', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  susanwild <- rtweet::get_timeline('@RepSusanWild', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  fletcher <- rtweet::get_timeline('@RepFletcher', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  escobar <- rtweet::get_timeline('@RepEscobar', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  jacksonlee <- rtweet::get_timeline('@JacksonLeeTX18', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  sylviagarcia <- rtweet::get_timeline('@RepSylviaGarcia', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  elaineluria<- rtweet::get_timeline('@RepElaineLuria', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  spanberger<- rtweet::get_timeline('@RepSpanberger', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  wexton <- rtweet::get_timeline('@RepWexton', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  delbene <- rtweet::get_timeline('@RepDelBene', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  herrerabeutler <- rtweet::get_timeline('@HerreraBeutler', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  jayapal<- rtweet::get_timeline('@RepJayapal', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  kimschrier <- rtweet::get_timeline('@RepKimSchrier', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  gwenmoore <- rtweet::get_timeline('@RepGwenMoore', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
...
hormaleR <- function() {
  donyoung <- rtweet::get_timeline('@repdonyoung', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  byrne <- rtweet::get_timeline('@RepByrne', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  mikerogers <- rtweet::get_timeline('@RepMikeRogersAL', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  robertaderholt <- rtweet::get_timeline('@Robert_Aderholt', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  mobrooks <- rtweet::get_timeline('@RepMoBrooks', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  garypalmer <- rtweet::get_timeline('@USRepGaryPalmer', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  rickcrawford <- rtweet::get_timeline('@RepRickCrawford', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  frenchhill<- rtweet::get_timeline('@RepFrenchHill', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  stevewomack <- rtweet::get_timeline('@rep_stevewomack', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  westerman <- rtweet::get_timeline('@RepWesterman', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  gosar <- rtweet::get_timeline('@RepGosar', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  andybiggs <- rtweet::get_timeline('@RepAndyBiggsAZ', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  david <- rtweet::get_timeline('@RepDavid', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  dlesko <- rtweet::get_timeline('@RepDLesko', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  lamalfa<- rtweet::get_timeline('@RepLaMalfa', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  mcclintock <- rtweet::get_timeline('@RepMcClintock', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  paulcook <- rtweet::get_timeline('@RepPaulCook', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  devinnunes <- rtweet::get_timeline('@RepDevinNunes', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  kevinmccarthy <- rtweet::get_timeline('@GOPLeader', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  kencalvert<- rtweet::get_timeline('@KenCalvert', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  tipton <- rtweet::get_timeline('@RepTipton', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  kenbuck <- rtweet::get_timeline('@RepKenBuck', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  dlamborn <- rtweet::get_timeline('@RepDLamborn', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  mattgaetz <- rtweet::get_timeline('@RepMattGaetz', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  nealdunn <- rtweet::get_timeline('@DrNealDunnFL2', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  tedyoho <- rtweet::get_timeline('@RepTedYoho', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  rutherford <- rtweet::get_timeline('@RepRutherfordFL', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  michaelwaltz <- rtweet::get_timeline('@RepMichaelWaltz', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  billposey <- rtweet::get_timeline('@congbillposey', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  webster <- rtweet::get_timeline('@RepWebster', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  gusbilirakis <- rtweet::get_timeline('@RepGusBilirakis', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  vernbuchanan<- rtweet::get_timeline('@VernBuchanan', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  gregsteube <- rtweet::get_timeline('@RepGregSteube', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  brianmast <- rtweet::get_timeline('@RepBrianMast', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  rooney <- rtweet::get_timeline('@RepRooney', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  mariodb <- rtweet::get_timeline('@MarioDB', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  buddycarter <- rtweet::get_timeline('@RepBuddyCarter', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  drewferguson <- rtweet::get_timeline('@RepDrewFerguson', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  robwoodall<- rtweet::get_timeline('@RepRobWoodall', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  austinscott <- rtweet::get_timeline('@AustinScottGA08', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  dougcollins <- rtweet::get_timeline('@RepDougCollins', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  hice <- rtweet::get_timeline('@CongressmanHice', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  loudermilk <- rtweet::get_timeline('@RepLoudermilk', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  rickallen <- rtweet::get_timeline('@RepRickAllen', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  tomgraves <- rtweet::get_timeline('@RepTomGraves', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  russfulcher <- rtweet::get_timeline('@RepRussFulcher', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  mikesimpson <- rtweet::get_timeline('@CongMikeSimpson', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  bost <- rtweet::get_timeline('@RepBost', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  rodneydavis <- rtweet::get_timeline('@RodneyDavis', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  shimkus <- rtweet::get_timeline('@RepShimkus', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  kinzinger <- rtweet::get_timeline('@RepKinzinger', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  lahood <- rtweet::get_timeline('@RepLaHood', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  jimbanks <- rtweet::get_timeline('@RepJimBanks', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  jimbaird <- rtweet::get_timeline('@RepJimBaird', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  gregpence <- rtweet::get_timeline('@RepGregPence', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  larrybucshon <- rtweet::get_timeline('@RepLarryBucshon', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  trey<- rtweet::get_timeline('@RepTrey', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  ronestes <- rtweet::get_timeline('@RepRonEstes', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  guthrie <- rtweet::get_timeline('@RepGuthrie', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  thomasmassie <- rtweet::get_timeline('@RepThomasMassie', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  halrogers<- rtweet::get_timeline('@RepHalRogers', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  andybarr <- rtweet::get_timeline('@RepAndyBarr', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  stevescalise <- rtweet::get_timeline('@SteveScalise', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  clayhiggins <- rtweet::get_timeline('@RepClayHiggins', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  mikejohnson <- rtweet::get_timeline('@RepMikeJohnson', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  abraham <- rtweet::get_timeline('@RepAbraham', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  garretgraves <- rtweet::get_timeline('@RepGarretGraves', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  andyharris<- rtweet::get_timeline('@RepAndyHarrisMD', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  jackbergman <- rtweet::get_timeline('@RepJackBergman', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  huizenga <- rtweet::get_timeline('@RepHuizenga', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  justinamash <- rtweet::get_timeline('@justinamash', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  moolenaar<- rtweet::get_timeline('@RepMoolenaar', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  fredupton <- rtweet::get_timeline('@RepFredUpton', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  walberg <- rtweet::get_timeline('@RepWalberg', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  slotkin <- rtweet::get_timeline('@RepSlotkin', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  paulmitchell <- rtweet::get_timeline('@RepPaulMitchell', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  hagedorn<- rtweet::get_timeline('@RepHagedorn', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  tomemmer <- rtweet::get_timeline('@RepTomEmmer', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  petestauber <- rtweet::get_timeline('@RepPeteStauber', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  blaine <- rtweet::get_timeline('@RepBlaine', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  samgraves<- rtweet::get_timeline('@RepSamGraves', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  long <- rtweet::get_timeline('@USRepLong', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  jasonsmith <- rtweet::get_timeline('@RepJasonSmith', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  trentkelly <- rtweet::get_timeline('@RepTrentKelly', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  michaelguest <- rtweet::get_timeline('@RepMichaelGuest', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  palazzo<- rtweet::get_timeline('@CongPalazzo', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  holding <- rtweet::get_timeline('@RepHolding', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  walterjones <- rtweet::get_timeline('@RepWalterJones', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  markwalker <- rtweet::get_timeline('@RepMarkWalker', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  davidrouzer <- rtweet::get_timeline('@RepDavidRouzer', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  richhudson <- rtweet::get_timeline('@RepRichHudson', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  patrickmchenry <- rtweet::get_timeline('@PatrickMcHenry', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  markmeadows <- rtweet::get_timeline('@RepMarkMeadows', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  tedbudd <- rtweet::get_timeline('@RepTedBudd', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  jefffortenberry <- rtweet::get_timeline('@JeffFortenberry', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  donbacon<- rtweet::get_timeline('@RepDonBacon', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  adriansmith <- rtweet::get_timeline('@RepAdrianSmith', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  jvd <- rtweet::get_timeline('@CongressmanJVD', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  chrissmith <- rtweet::get_timeline('@RepChrisSmith', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  markamodei <- rtweet::get_timeline('@MarkAmodeiNV2', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  leezeldin <- rtweet::get_timeline('@RepLeeZeldin', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  peterking <- rtweet::get_timeline('@RepPeteKing', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  tomreed <- rtweet::get_timeline('@RepTomReed', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  johnkatko <- rtweet::get_timeline('@RepJohnKatko', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  chriscollins <- rtweet::get_timeline('@RepChrisCollins', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  stevechabot <- rtweet::get_timeline('@RepSteveChabot', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  bradwenstrup<- rtweet::get_timeline('@RepBradWenstrup', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  jimjordan<- rtweet::get_timeline('@Jim_Jordan', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  boblatta <- rtweet::get_timeline('@boblatta', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  billjohnson <- rtweet::get_timeline('@RepBillJohnson', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  bobgibbs <- rtweet::get_timeline('@RepBobGibbs', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  warrendavidson <- rtweet::get_timeline('@WarrenDavidson', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  miketurner <- rtweet::get_timeline('@RepMikeTurner', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  balderson <- rtweet::get_timeline('@RepBalderson', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  davejoyce <- rtweet::get_timeline('@RepDaveJoyce', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  stevestivers <- rtweet::get_timeline('@RepSteveStivers', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  agonzalez<- rtweet::get_timeline('@RepAGonzalez', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  kevinhern <- rtweet::get_timeline('@repkevinhern', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  mullin <- rtweet::get_timeline('@RepMullin', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  franklucas <- rtweet::get_timeline('@RepFrankLucas', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  tomcole <- rtweet::get_timeline('@TomColeOK04', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  brianfitz <- rtweet::get_timeline('@RepBrianFitz', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  meuser <- rtweet::get_timeline('@RepMeuser', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  scottperry <- rtweet::get_timeline('@RepScottPerry', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  smucker <- rtweet::get_timeline('@RepSmucker', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  johnjoyce <- rtweet::get_timeline('@RepJohnJoyce', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  greschenthaler <- rtweet::get_timeline('@GReschenthaler', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  gt <- rtweet::get_timeline('@CongressmanGT', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  mikekelly <- rtweet::get_timeline('@MikeKellyPA', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  joewilson <- rtweet::get_timeline('@RepJoeWilson', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  jeffduncan <- rtweet::get_timeline('@RepJeffDuncan', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  timmons <- rtweet::get_timeline('@reptimmons', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  ralphnorman <- rtweet::get_timeline('@RepRalphNorman', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  tomrice <- rtweet::get_timeline('@RepTomRice', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  dustyjohnson <- rtweet::get_timeline('@RepDustyJohnson', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  philroe <- rtweet::get_timeline('@DrPhilRoe', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  timburchett <- rtweet::get_timeline('@RepTimBurchett', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  chuck <- rtweet::get_timeline('@RepChuck', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  desjarlais <- rtweet::get_timeline('@DesJarlaisTN04l', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  johnrose <- rtweet::get_timeline('@RepJohnRose', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  markgreen <- rtweet::get_timeline('@RepMarkGreen', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  davidkustoff <- rtweet::get_timeline('@RepDavidKustoff', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  louiegohmert <- rtweet::get_timeline('@replouiegohmert', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  dancrenshaw<- rtweet::get_timeline('@RepDanCrenshaw', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  vantaylor <- rtweet::get_timeline('@RepVanTaylor', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  ratcliffe <- rtweet::get_timeline('@RepRatcliffe', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  lancegooden <- rtweet::get_timeline('@RepLanceGooden', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  ronwright <- rtweet::get_timeline('@RepRonWright', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  kevinbrady <- rtweet::get_timeline('@RepKevinBrady', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  mccaul <- rtweet::get_timeline('@RepMcCaul', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  conaway <- rtweet::get_timeline('@ConawayTX11', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  kaygranger <- rtweet::get_timeline('@RepKayGranger', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  mac <- rtweet::get_timeline('@MacTXPress', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  randy <- rtweet::get_timeline('@TXRandy14', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  billflores <- rtweet::get_timeline('@RepBillFlores', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  arrington <- rtweet::get_timeline('@RepArrington', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  chiproy <- rtweet::get_timeline('@RepChipRoy', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  peteolson <- rtweet::get_timeline('@RepPeteOlson', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  hurd <- rtweet::get_timeline('@HurdOnTheHill', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  kenmarchant <- rtweet::get_timeline('@RepKenMarchant', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  rwilliams <- rtweet::get_timeline('@RepRWilliams', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  michaelburgess <- rtweet::get_timeline('@michaelcburgess', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  cloud<- rtweet::get_timeline('@RepCloudTX', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  carter <- rtweet::get_timeline('@JudgeCarter', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  brianbabin <- rtweet::get_timeline('@RepBrianBabin', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  robbishop <- rtweet::get_timeline('@RepRobBishop', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  chrisstewart <- rtweet::get_timeline('@RepChrisStewart', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  johncurtis <- rtweet::get_timeline('@RepJohnCurtis', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  robwittman <- rtweet::get_timeline('@RobWittman', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  riggleman <- rtweet::get_timeline('@RepRiggleman', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  bencline <- rtweet::get_timeline('@RepBenCline', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  mgriffith <- rtweet::get_timeline('@RepMGriffith', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  newhouse <- rtweet::get_timeline('@RepNewhouse', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  bryansteil <- rtweet::get_timeline('@RepBryanSteil', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  jim <- rtweet::get_timeline('@JimPressOffice', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  grothman <- rtweet::get_timeline('@RepGrothman', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  seanduffy <- rtweet::get_timeline('@RepSeanDuffy', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  gallagher <- rtweet::get_timeline('@RepGallagher', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  mckinley <- rtweet::get_timeline('@RepMcKinley', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  alexmooney <- rtweet::get_timeline('@RepAlexMooney', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
...
hormaleD <- function() {
  ohalleran <- rtweet::get_timeline('@RepOHalleran', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  raulgrijalva<- rtweet::get_timeline('@RepRaulGrijalva', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  rubengallego <- rtweet::get_timeline('@RepRubenGallego', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  gregstanton<- rtweet::get_timeline('@RepGregStanton', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  garamendi<- rtweet::get_timeline('@RepGaramendi', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  thompson<- rtweet::get_timeline('@RepThompson', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  mcnerney <- rtweet::get_timeline('@RepMcNerney', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  joshharder <- rtweet::get_timeline('@RepJoshHarder', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  desaulnier<- rtweet::get_timeline('@RepDeSaulnier', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  swalwell<- rtweet::get_timeline('@RepSwalwell', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  jimcosta <- rtweet::get_timeline('@RepJimCosta', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  rokhanna <- rtweet::get_timeline('@RepRoKhanna', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  jimmypanetta <- rtweet::get_timeline('@RepJimmyPanetta', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  tjcox<- rtweet::get_timeline('@RepTjCox', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  carbajal <- rtweet::get_timeline('@RepCarbajal', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  adamschiff <- rtweet::get_timeline('@RepAdamSchiff', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  cardenas<- rtweet::get_timeline('@RepCardenas', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  bradsherman <- rtweet::get_timeline('@BradSherman', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  peteaguilar<- rtweet::get_timeline('@RepPeteAguilar', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  tedlieu<- rtweet::get_timeline('@RepTedLieu', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  jimmygomez <- rtweet::get_timeline('@RepJimmyGomez', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  ruiz<- rtweet::get_timeline('@CongressmanRuiz', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  gilcisneros <- rtweet::get_timeline('@RepGilCisneros', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  marktakano<- rtweet::get_timeline('@RepMarkTakano', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  loucorrea<- rtweet::get_timeline('@RepLouCorrea', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  lowenthal<- rtweet::get_timeline('@RepLowenthal', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  harley<- rtweet::get_timeline('@RepHarley', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  mikelevin <- rtweet::get_timeline('@RepMikeLevin', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  hunter<- rtweet::get_timeline('@Rep_Hunter', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  juanvargas <- rtweet::get_timeline('@RepJuanVargas', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  scottpeters<- rtweet::get_timeline('@RepScottPeters', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  joeneguse<- rtweet::get_timeline('@RepJoeNeguse', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  jasoncrow<- rtweet::get_timeline('@RepJasonCrow', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  perlmutter<- rtweet::get_timeline('@RepPerlmutter', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  johnlarson<- rtweet::get_timeline('@RepJohnLarson', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  joecourtney<- rtweet::get_timeline('@RepJoeCourtney', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  jahimes<- rtweet::get_timeline('@jahimes', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  allawson <- rtweet::get_timeline('@RepAlLawsonJr', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  darrensoto <- rtweet::get_timeline('@RepDarrenSoto', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  valdemings<- rtweet::get_timeline('@RepValDemings', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  charliecrist<- rtweet::get_timeline('@RepCharlieCrist', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  teddeutch<- rtweet::get_timeline('@RepTedDeutch', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  sanfordbishop<- rtweet::get_timeline('@SanfordBishop', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  hankjohnson<- rtweet::get_timeline('@RepHankJohnson', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  johnlewis<- rtweet::get_timeline('@repjohnlewis', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  lucymcbath<- rtweet::get_timeline('@RepLucyMcBath', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  davidscott<- rtweet::get_timeline('@repdavidscott', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  edcase<- rtweet::get_timeline('@RepEdCase', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  daveloebsack <- rtweet::get_timeline('@daveloebsack', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  bobbyrush<- rtweet::get_timeline('@RepBobbyRush', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  lipinski<- rtweet::get_timeline('@RepLipinski', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  chuygarcia <- rtweet::get_timeline('@RepChuyGarcia', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  mikequigley<- rtweet::get_timeline('@RepMikeQuigley', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  casten<- rtweet::get_timeline('@RepCasten', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  dannydavis <- rtweet::get_timeline('@RepDannyDavis', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  raja<- rtweet::get_timeline('@CongressmanRaja', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  schneider <- rtweet::get_timeline('@RepSchneider', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  billfoster<- rtweet::get_timeline('@RepBillFoster', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  visclosky<- rtweet::get_timeline('@RepVisclosky', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  andrecarson<- rtweet::get_timeline('@RepAndreCarson', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  johnyarmuth<- rtweet::get_timeline('@RepJohnYarmuth', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  richmond<- rtweet::get_timeline('@RepRichmond', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  chelliepingree <- rtweet::get_timeline('@chelliepingree', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  golden<- rtweet::get_timeline('@RepGolden', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  dutch <- rtweet::get_timeline('@Call_Me_Dutch', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  sarbanes <- rtweet::get_timeline('@RepSarbanes', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  anthonybrown <- rtweet::get_timeline('@RepAnthonyBrown', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  hoyer<- rtweet::get_timeline('@LeaderHoyer', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  davidtrone<- rtweet::get_timeline('@RepDavidTrone', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  cummings<- rtweet::get_timeline('@RepCummings', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  raskin <- rtweet::get_timeline('@RepRaskin', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  richardneal <- rtweet::get_timeline('@RepRichardNeal', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  mcgovern<- rtweet::get_timeline('@RepMcGovern', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  joekennedy <- rtweet::get_timeline('@RepJoeKennedy', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  moulton<- rtweet::get_timeline('@teammoulton', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  stephenlynch <- rtweet::get_timeline('@RepStephenLynch', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  keating<- rtweet::get_timeline('@USRepKeating', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  dankildee <- rtweet::get_timeline('@RepDanKildee', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  andylevin<- rtweet::get_timeline('@RepAndyLevin', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  cleaver<- rtweet::get_timeline('@repcleaver', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  benniethompson <- rtweet::get_timeline('@BennieGThompson', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  gkbutterfield<- rtweet::get_timeline('@GKButterfield', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  davidprice<- rtweet::get_timeline('@RepDavidEPrice', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  chrispappas<- rtweet::get_timeline('@RepChrisPappas', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  donaldnorcross<- rtweet::get_timeline('@DonaldNorcross', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  andykim<- rtweet::get_timeline('@RepAndyKimNJ', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  joshg <- rtweet::get_timeline('@RepJoshG', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  frankpallone <- rtweet::get_timeline('@FrankPallone', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  malinowski<- rtweet::get_timeline('@RepMalinowski', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  sires<- rtweet::get_timeline('@RepSires', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  billpascrell <- rtweet::get_timeline('@BillPascrell', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  donaldpayne<- rtweet::get_timeline('@RepDonaldPayne', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  sherrill<- rtweet::get_timeline('@RepSherrill', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  benraylujan <- rtweet::get_timeline('@repbenraylujan', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  horsford<- rtweet::get_timeline('@RepHorsford', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  tomsuozzi <- rtweet::get_timeline('@RepTomSuozzi', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  gregorymeeks<- rtweet::get_timeline('@RepGregoryMeeks', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  gracemeng<- rtweet::get_timeline('@RepGraceMeng', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  jeffries<- rtweet::get_timeline('@RepJeffries', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  jerrynadler <- rtweet::get_timeline('@RepJerryNadler', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  maxrose<- rtweet::get_timeline('@RepMaxRose', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  espaillat <- rtweet::get_timeline('@RepEspaillat', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  joseserrano<- rtweet::get_timeline('@RepJoseSerrano', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  eliotengel<- rtweet::get_timeline('@RepEliotEngel', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  seanmaloney<- rtweet::get_timeline('@RepSeanMaloney', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  delgado<- rtweet::get_timeline('@repdelgado', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  paultonko <- rtweet::get_timeline('@RepPaulTonko', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  brindisi<- rtweet::get_timeline('@RepBrindisi', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  joemorelle <- rtweet::get_timeline('@RepJoeMorelle', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  brianhiggins<- rtweet::get_timeline('@RepBrianHiggins', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  timryan<- rtweet::get_timeline('@RepTimRyan', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  gregwalden <- rtweet::get_timeline('@repgregwalden', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  blumenauer<- rtweet::get_timeline('@repblumenauer', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  peterdefazio<- rtweet::get_timeline('@RepPeterDeFazio', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  schrader<- rtweet::get_timeline('@RepSchrader', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  boyle <- rtweet::get_timeline('@CongBoyle', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  dwightevans <- rtweet::get_timeline('@RepDwightEvans', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  cartwright<- rtweet::get_timeline('@RepCartwright', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  conorlamb<- rtweet::get_timeline('@RepConorLamb', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  mikedoyle<- rtweet::get_timeline('@USRepMikeDoyle', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  davidcicilline<- rtweet::get_timeline('@davidcicilline', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  jimlangevin<- rtweet::get_timeline('@JimLangevin', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  cunningham<- rtweet::get_timeline('@RepCunningham', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  clyburn<- rtweet::get_timeline('@WhipClyburn', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  jimcooper <- rtweet::get_timeline('@repjimcooper', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  cohen<- rtweet::get_timeline('@RepCohen', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  algreen <- rtweet::get_timeline('@RepAlGreen', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  gonzalez <- rtweet::get_timeline('@RepGonzalez', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  joaquincastro <- rtweet::get_timeline('@JoaquinCastrotx', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  cuellar<- rtweet::get_timeline('@RepCuellar', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  ebj <- rtweet::get_timeline('@RepEBJ', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  colinallred <- rtweet::get_timeline('@RepColinAllred', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  veasey<- rtweet::get_timeline('@RepVeasey', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  filemonvela <- rtweet::get_timeline('@RepFilemonVela', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  lloyddoggett<- rtweet::get_timeline('@RepLloydDoggett', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  benmcadams<- rtweet::get_timeline('@RepBenMcAdams', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  bobbyscott<- rtweet::get_timeline('@BobbyScott', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  mceachin<- rtweet::get_timeline('@RepMcEachin', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  donbeyer <- rtweet::get_timeline('@RepDonBeyer', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  gerryconnolly <- rtweet::get_timeline('@GerryConnolly', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  peterwelch<- rtweet::get_timeline('@PeterWelch', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  ricklarsen<- rtweet::get_timeline('@RepRickLarsen', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  derekkilmer<- rtweet::get_timeline('@RepDerekKilmer', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  adamsmith<- rtweet::get_timeline('@RepAdamSmith', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  dennyheck<- rtweet::get_timeline('@RepDennyHeck', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  markpocan<- rtweet::get_timeline('@repmarkpocan', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  ronkind<- rtweet::get_timeline('@RepRonKind', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
  carolmiller <- rtweet::get_timeline('@RepCarolMiller', n = 50, max_id = NULL, home = FALSE, parse = TRUE, check = FALSE, token = key, include_rts = FALSE)
